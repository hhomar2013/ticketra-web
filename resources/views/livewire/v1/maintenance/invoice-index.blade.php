<div>
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h6 class="fw-bold mb-0">{{ __('Maintenance Invoices') }}</h6>
            <small class="text-muted">{{ __('Manage maintenance invoices') }}</small>
        </div>
        <a href="{{ route('maintenance.invoices.create') }}" wire:navigate
            ...
            <table class="table table-hover align-middle mb-0">
                <thead style="background:#f9fafb;">
                    <tr>
                        ...
                        <th class="py-3 text-muted small">{{ __('Invoice Date') }}</th>
                        <th class="py-3 text-muted small">{{ __('Total Amount') }}</th>
                        <th class="py-3 text-muted small">{{ __('Status') }}</th>
                        <th class="py-3 text-muted small">{{ __('Created by') }}</th>
                        <th class="py-3 text-muted small">{{ __('Received by') }}</th>
                        <th class="py-3 text-muted small">{{ __('Received Date') }}</th>
                ...
                <tbody>
                    @foreach ($invoices as $key => $invoice)
                        <tr>
                            ...
                            <td>
                                <span class="fw-bold small">
                                    {{ $invoice->receivedBy->name }}
                                </span>
                            </td>
                            <td>
                                <span class="fw-bold small">
                                    {{ \Carbon\Carbon::parse($invoice->received_date)->format('d M Y') }}
                                </span>
                            </td>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('invoices.edit', $invoice->id) }}" wire:navigate>
