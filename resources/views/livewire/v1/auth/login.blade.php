            ...
            <form wire:submit.prevent="login">
                ...
                <div class="field-group">
                    ...
                    <div class="field-wrap">
                        ...
                        <input type="email" wire:model="email" class="f-input @error('email') is-invalid @enderror" placeholder="you@company.com" autocomplete="email">
                    </div>
                    @error('email')
                    <div class="f-error">
                ...
                <div class="field-group">
                    ...
                    <div class="field-wrap">
                        ...
                        <input type="password" wire:model="password" class="f-input @error('password') is-invalid @enderror" placeholder="••••••••" autocomplete="current-password">
                    </div>
                    @error('password')
                    <div class="f-error">
                        <i class="fas fa-circle-exclamation"></i> {{ $message }}
