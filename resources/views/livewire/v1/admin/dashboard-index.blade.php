<div class="p-4">
    ...
    {{-- <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0 small">Here's what's happening with your tickets today.</p>
        </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-end justify-content-between gap-2" style="height: 120px;">
                        ...
                        <div class="d-flex flex-column align-items-center flex-fill">
                            ...
                            <div class="bar-chart-bar w-100 bg-primary" style="height: {{ $height }}%; opacity: {{ $day['day'] === now()->format('D') ? '1' : '.5' }};">
                            </div>
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius: 16px;">
                <div class="card-body p-4">
                    ...
                    <div class="text-center my-4">
                        ...
                        <div class="mt-1">
                            @for ($i = 1; $i <= 5; $i++) <i class="fa fa-star" style="color: {{ $i <= round($avgRating) ? '#ffc107' : '#dee2e6' }};"></i>
                                @endfor
                        </div>
                    ...
                    <div class="vstack gap-2">
                        @for ($i = 5; $i >= 1; $i--)
                        @php $cnt = $ratingCounts[$i] ?? 0; $pct = $totalFeedbacks > 0 ? ($cnt / $totalFeedbacks) * 100 : 0; @endphp
                        ...
                        <tbody>
                            ...
                            <tr class="ticket-row">
                                ...
                                <td style="max-width: 180px;">
                                    <a href="{{ route('it.tickets.show', $ticket->id) }}" class="text-decoration-none text-dark fw-bold text-truncate d-block" title="{{ $ticket->title }}">
                                        {{ $ticket->title }}
                                    </a>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex align-items-center gap-1">
                                        <div class="agent-avatar bg-success bg-opacity-10 text-success" style="width:28px;height:28px;font-size:10px;">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-center gap-3 mb-3 p-2 rounded-3" style="background: #f8f9fa;">
                        <div class="position-relative">
                            ...
                            @if ($index === 0)
                            <span class="position-absolute top-0 start-100 translate-middle" style="font-size: 10px;">🏆</span>
                            @endif
                        </div>
                        <div class="flex-fill">
                    ...
                    <hr class="my-3">
                    <a href="{{ route('it.reports.feedback') }}" class="btn btn-outline-warning w-100 btn-sm rounded-pill">
