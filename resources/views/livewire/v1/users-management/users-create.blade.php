        ...
        <div class="form-panel shadow-sm">
            ...
            <div class="form-panel-body">
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="f-wrap">
                            ...
                            <input type="email" wire:model.live="email"
                                class="f-input @error('email') is-invalid @enderror" placeholder="user@company.com">
                        </div>
                        @error('email')
                            <div class="f-err"><i class="fa fa-circle-exclamation"></i> {{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        <label class="f-lbl">{{ __('Department') }} <span class="text-danger">*</span></label>
                        <div class="f-wrap">
                            <i class="fa-solid fa-layer-group f-ico"></i>
                    ...
                    {{-- ── Security ── --}}
                    <div class="col-12">
                        <div class="section-divider">{{ __('Security') }}</div>
                    </div>
                        ...
                        <label class="f-lbl">
                            ...
                            @if ($IsEdit)
                                <span class="text-muted fw-normal"
                                    style="text-transform:none;letter-spacing:0;">({{ __('leave blank to keep') }})</span>
                            @else
                        ...
                        <div class="toggle-wrap p-3 rounded-3" style="background:#f9fafb;border:1px solid #f3f4f6;">
                            <div>
                                ...
                                <div class="text-muted" style="font-size: 12px;">
                                    {{ __('User can login to the system') }}</div>
                            </div>
        ...
        <div class="side-panel">
            ...
            <div class="preview-card shadow-sm">
                <div style="position:relative;z-index:1;">
                    ...
                    @endphp
                    <div
                        style="width:52px;height:52px;border-radius:50%;background:rgba(255,255,255,.2);display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:800;color:#fff;margin-bottom:12px;">
                        {{ $ini }}
                    </div>
                    ...
                    @if ($role)
                        <div
                            style="background:rgba(255,255,255,.15);border-radius:20px;padding:4px 12px;display:inline-block;font-size:12px;font-weight:700;color:#fff;">
