<div>
    <header class="app-header">
        <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                    ...
                    <li class="nav-item">
                        <div class="dropdown" dir="ltr">
                            <a class="btn btn-dark position-relative" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow" style="min-width: 300px; max-height: 400px; overflow-y: auto;">
                                <li class="dropdown-header border-bottom">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        @if (auth()->user()->unreadNotifications->count() > 0)
                                        <a href="#" wire:click="markAllAsRead" class="text-primary" style="text-decoration: none; font-size: 0.75rem;">
                                            {{ __('Read all') }}
                                        </a>
                                        @endif
                                    </div>
            ...
            font-size: 13px;
            font-weight: 600;" class=" bg-success bg-opacity-50  text-dark">
