        ...
        <div class="form-panel shadow-sm">
            ...
            <div class="form-panel-body">
                ...
                <form wire:submit="submit">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="f-wrap">
                                ...
                                {{-- ✅ نفس wire:model --}}
                                <input type="text" class="f-input @error('asset_tag') is-invalid @enderror"
                                    id="asset_tag" wire:model="asset_tag" placeholder="AST-0001">
                            </div>
                            @error('asset_tag')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="f-wrap">
                                ...
                                {{-- ✅ نفس wire:model --}}
                                <input type="text" class="f-input @error('serial_number') is-invalid @enderror"
                                    id="serial_number" wire:model="serial_number" placeholder="SN-XXXXXXXXXX">
                            </div>
                            @error('serial_number')
                                <div class="f-err"><i class="fa fa-circle-exclamation"></i> {{ $message }}</div>
                            @enderror
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="f-wrap">
                                ...
                                {{-- ✅ نفس wire:model --}}
                                <select class="f-input @error('category_id') is-invalid @enderror" id="category_id"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="f-wrap">
                                ...
                                {{-- ✅ نفس wire:model --}}
                                <select class="f-input @error('branch_id') is-invalid @enderror" id="branch_id"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="f-wrap">
                                ...
                                <select class="f-input @error('brand_id') is-invalid @enderror" id="brand_id"
                                    wire:model.live="brand_id" wire:change="getTypeModels()">
                        ...
                        <div class="col-md-6" wire:ignore.self>
                            ...
                            <div class="f-wrap">
                                ...
                                {{-- ✅ نفس wire:model --}}
                                <select class="f-input @error('type_model_id') is-invalid @enderror" id="type_model_id"
                                    wire:model="type_model_id">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="f-wrap">
                                ...
                                {{-- ✅ نفس wire:model --}}
                                <input type="date" class="f-input @error('purchase_date') is-invalid @enderror"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="f-wrap">
                                ...
                                {{-- ✅ نفس wire:model --}}
                                <input type="date" class="f-input @error('warranty_expiry') is-invalid @enderror"
                                    id="warranty_expiry" wire:model="warranty_expiry">
                            </div>
                    ...
                    <div class="section-divider">{{ __('Specification') }}</div>
                    <div class="row g-3 mb-4">

                        @foreach ($specs as $spec)
                            <div class="col-md-6 mt-2">
                                <label class="f-lbl">{{ $spec->name }}</label>
                                <div class="f-wrap">
                                    <i class="fa-solid fa-circle-dot f-ico"></i>
                                    <input type="text"
                                        class="f-input @error('spec_values.' . $spec->id) is-invalid @enderror"
                                        id="spec_values_{{ $spec->id }}"
                                        wire:model="spec_values.{{ $spec->id }}">
                                </div>
                                @error('spec_values.' . $spec->id)
                    ...
                    <div class="d-flex align-items-center gap-2 pt-4" style="border-top: 1px solid #f3f4f6;">
                        ...
                        {{-- ✅ نفس wire:click --}}
                        <button type="button" wire:click="backToAssets"
        ...
        <div class="side-panel">
            ...
            <div class="preview-card shadow-sm">
                <div style="position: relative; z-index: 1;">
                    ...
                    <div
                        style="color: #fff; font-family: monospace; font-weight: 700;
