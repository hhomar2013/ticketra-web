<div>
    ...
    <style>
        ...
        .f-lbl {
            ...
            color: #9ca3af; margin-bottom: 7px; display: block;
        }
        ...
        .f-wrap .f-ico.ta { top: 14px; transform: none; }
        ...
        .f-input {
            ...
            background: #fafafa; transition: all .2s; outline: none;
        }
        ...
        textarea.f-input { padding-left: 40px; resize: none; }
        .f-err {
        ...
        .asset-info-row .a-label { color: #9ca3af; font-size: 11px; font-weight: 700; letter-spacing: .5px; text-transform: uppercase; }
        .asset-info-row .a-value { font-weight: 700; color: #111827; font-family: monospace; }
        ...
        <div class="form-panel shadow-sm">
            ...
            <div class="form-panel-body">
                ...
                <form wire:submit="assignToEmployee">
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <div class="f-wrap">
                                ...
                                <textarea class="f-input @error('notes') is-invalid @enderror"
                    ...
                    <div class="d-flex align-items-center gap-2 mt-4 pt-4"
            ...
            <div class="asset-info-card shadow-sm">
                <div class="info-header">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <div style="color: rgba(255,255,255,.6); font-size: 11px; text-transform: uppercase; letter-spacing: .5px;">
                                {{ __('Asset Info') }}
                            </div>
                ...
                <div class="asset-info-row">
                    ...
                    <span style="background: rgba(13,110,253,.1); color: #0d6efd;
                ...
                <div style="position: relative; z-index: 1;">
                    @php
                        ...
                        $selectedBranch = $branch_id
                            ? \App\Models\branch::find($branch_id)
                            : null;
