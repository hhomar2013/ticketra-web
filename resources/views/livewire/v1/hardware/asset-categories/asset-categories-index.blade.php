<div>
    ...
    <div>
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <button wire:click="changeAction('create')" class="btn btn-primary btn-sm rounded-pill px-4 fw-bold shadow-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pe-4 text-end">
                            <button wire:click="editCategory({{ $category->id }})" class="btn btn-sm rounded-pill px-3 me-1" style="background: rgba(13,110,253,.08); color: #0d6efd;
                                           border: 1px solid rgba(13,110,253,.15); font-size: 12px;">
                                <i class="fas fa-edit me-1"></i> {{ __('Edit') }}
                            </button>
                            <button onclick="confirmDelete({{ $category->id }}, 'delete-category')" class="btn btn-sm rounded-pill px-3" style="background: rgba(220,53,69,.08); color: #dc3545;
