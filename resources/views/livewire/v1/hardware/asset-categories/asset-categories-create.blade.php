    ...
    <div class="branch-page">
            ...
            <div class="form-panel-header">
                ...
                <div>
                    <h5 class="fw-bold mb-0" style="font-size: 16px;">
                        {{ $IsEdit ? __('Edit Category') : __('Create New Category') }}
                    </h5>
                ...
                <form wire:submit.prevent="submitCategory">
                    ...
                    <div class="d-flex align-items-center gap-2 mt-4 pt-4" style="border-top: 1px solid #f3f4f6;">
                        <button type="submit" class="btn-submit">
                            <span wire:loading.remove wire:target="submitCategory">
                                <i class="fa {{ $IsEdit ? 'fa-floppy-disk' : 'fa-plus' }}"></i>
                                {{ $IsEdit ? __('Save Changes') : __('Create Category') }}
                            </span>
        ...
        <div class="side-panel">
            ...
            <div class="info-card">
                ...
                <div class="tip-item">
                    <div class="tip-dot" style="background: #6f42c1;"></div>
                    <span>{{ __('Use clear names like "Computers", "Printers", "Networking"') }}</span>
                </div>
                <div class="tip-item">
                    <div class="tip-dot" style="background: #6f42c1;"></div>
                    <span>{{ __('The slug is used in URLs — keep it short and lowercase') }}</span>
                </div>
                <div class="tip-item">
                    <div class="tip-dot" style="background: #6f42c1;"></div>
                    <span>{{ __('Categories help organize and filter assets easily') }}</span>
                </div>
                <div class="tip-item">
                    <div class="tip-dot" style="background: #10b981;"></div>
                    <span>{{ __('Add a description to help team members understand the category') }}</span>
                </div>
            </div>
