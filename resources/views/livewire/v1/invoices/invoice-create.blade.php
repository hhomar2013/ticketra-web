                    ...
                    <div class="col-md-6">
                        ...
                        <div class="f-wrap">
                            ...
                            <input type="text" wire:model.live="invoice_number"
                                class="f-input @error('invoice_number') is-invalid @enderror"
                        ...
                        <div class="col-12">
                            ...
                            <div class="batch-section {{ $addBatch ? 'active' : '' }}">
                                ...
                                <div class="toggle-wrap mb-3">
                                    <div>
                                        ...
                                        <div class="text-muted" style="font-size:12px;">
                                            {{ __('Create a batch linked to this invoice') }}</div>
                                    </div>
                                ...
                                @if ($addBatch)
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label class="f-lbl">{{ __('Batch Number') }} <span
                                                    class="text-danger">*</span></label>
                                            <div class="f-wrap">
                                                <i class="fa fa-boxes-stacked f-ico"></i>
                                                <input type="text" wire:model="batch_number"
                                                    class="f-input @error('batch_number') is-invalid @enderror"
                                                    placeholder="BATCH-2025-001">
                                            </div>
                                            @error('batch_number')
                                                <div class="f-err"><i class="fa fa-circle-exclamation"></i>
                                                    {{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            <label class="f-lbl">{{ __('Received Date') }} <span
                                                    class="text-danger">*</span></label>
                                            <div class="f-wrap">
                                                <i class="fa fa-calendar f-ico"></i>
            ...
            <div class="preview-card shadow-sm">
                <div style="position:relative;z-index:1;">
                    ...
                    @if ($addBatch && !$IsEdit && $batch_number)
                        <div class="p-row"
                            style="margin-top:10px;padding-top:10px;border-top:1px solid rgba(255,255,255,.15);">
