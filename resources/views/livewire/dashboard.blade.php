                        ...
                        <div class="col-lg-2">
                            <div class="card rounded-lg bg-secondary bg-opacity-75 text-white">
                                <div class="card-body">
                                    ...
                                    <i class="fas fa-ticket text-3xl font-bold"></i>
                                    <p class="card-text text-3xl font-bold p-3">
                                        {{ $total_tickets->where('status', 'new')->count() }}</p>
                                </div>
                        ...
                        <div class="col-lg-2">
                            <div class="card rounded-lg bg-success bg-opacity-75 text-white">
                                <div class="card-body">
                                    ...
                                    <i class="fas fa-ticket text-3xl font-bold"></i>
                                    <p class="card-text text-3xl font-bold p-3">
                                        {{ $total_tickets->where('status', 'open')->count() }}</p>
                                </div>
                        ...
                        <div class="col-lg-2">
                            <div class="card rounded-lg bg-warning bg-opacity-75 text-white">
                                <div class="card-body">
                                    ...
                                    <i class="fas fa-ticket text-3xl font-bold"></i>
                                    <p class="card-text text-3xl font-bold p-3">
                                        {{ $total_tickets->where('status', 'in_progress')->count() }}</p>
                                </div>
                        ...
                        <div class="col-lg-2">
                            <div class="card rounded-lg bg-danger text-white">
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-3xl font-bold p-3">
                                        {{ $total_tickets->where('status', 'closed')->count() }}</p>
                                </div>
