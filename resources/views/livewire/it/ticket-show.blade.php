...
<div class="p-2">
    ...
    <style>
        ...
        /* ── Chat Row ── */
        .chat-row {
            animation: fadeUp .22s ease-in-out;
            margin-bottom: 14px;
        }
    ...
    <div class="card border-0 shadow-sm" style="border-radius: 20px; overflow: hidden;">
        ...
        <div class="card-header bg-dark text-white p-4" style="border-radius: 20px 20px 0 0;">
            <div class="d-flex align-items-start gap-3">
                <div
                    style="width: 44px; height: 44px; min-width: 44px; border-radius: 12px;
            ...
            @if ($image)
                <div class="mt-3">
                    <a href="{{ asset('storage/' . $image) }}" target="_blank">
                        <img src="{{ asset('storage/' . $image) }}" class="rounded-3 border border-secondary"
        ...
        <div class="card-body p-4">
                    ...
                    @if ($ticket->status !== \App\Core\Enum\TicketStatus::Closed)
                        <div class="col-lg-6 mt-3 mt-lg-0">
                            <form wire:submit.prevent="update_Status"
                                ...
                                <select wire:model="status" class="form-select form-select-sm shadow-sm"
                                    style="width: 160px;">
            ...
            {{-- ══════════════ CHAT ══════════════ --}}
            <div class="rounded-4 p-3 mb-3" style="background: #111318; border: 1px solid rgba(255,255,255,.07);">
                ...
                <div class="d-flex align-items-center gap-2 mb-3 pb-2"
                    ...
                    <span class="badge bg-primary bg-opacity-20 text-white ms-1" style="font-size: 11px;">
                ...
                <div class="chat-wrapper" id="chat-container">
                    @forelse ($ticket->replies as $reply)
                        ...
                        <div
                            class="d-flex chat-row gap-2 align-items-end
                ...
                <div class="typing-indicator" id="typing-indicator">
                    <div class="chat-avatar other" style="width:28px;height:28px;font-size:10px;" id="typing-avatar">?
                    </div>
                ...
                @if ($ticket->status != TicketStatus::Closed)
                    ...
                    <div class="reply-box mt-3">
                        ...
                        <form wire:submit.prevent="addReply" class="d-flex align-items-end gap-2 flex-fill">
                            <textarea wire:model.live="message" id="reply-textarea" class="reply-textarea form-control" rows="1"
            ...
            {{-- ══════════════ FEEDBACK ══════════════ --}}
            @if ($ticket->status === TicketStatus::Closed && auth()->id() === $ticket->user_id)
                ...
                @else
                    <div class="rounded-4 p-4" style="background: #111318; border: 1px solid rgba(255,255,255,.07);">
                        ...
                        <div class="star-rating d-flex justify-content-center gap-3 mb-3">
                            @for ($i = 1; $i <= 5; $i++)
                                <i class="fa fa-star" wire:click="setRating({{ $i }})"
                        ...
                        <textarea wire:model.live="comment" rows="3" class="form-control mb-3"
                            style="background: rgba(255,255,255,.05); border: 1px solid rgba(255,255,255,.1);
                                   color: #f8f9fa; border-radius: 12px;"
                            placeholder="{{ __('Add a comment (optional)...') }}" maxlength="500">
                        </textarea>
...
<script>
    document.addEventListener('livewire:initialized', () => {
        ...
        const scrollToBottom = (behavior = 'smooth') => {
            ...
            setTimeout(() => chatContainer.scrollTo({
        ...
        chatContainer?.addEventListener('scroll', () => {
            const isBottom = chatContainer.scrollHeight - chatContainer.scrollTop <= chatContainer
                .clientHeight + 100;
        ...
        textarea?.addEventListener('input', () => {
            ...
            window.Echo.private(`ticket.${ticketId}`).whisper('typing', {
                name: authName
            });
